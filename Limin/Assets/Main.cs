...
public class Main : MonoBehaviour
{
    ...
    public Color backgroundColor = new Color(.34f, 0, .29f);
    public Color letterColor = new Color(.99f, .93f, .01f);
    ...
    private int carretPositionX = 200;
    private int carretPositionY = 2000;
